...
class Lookahead(nn.Module):
    ...
    # output_latest_ds2v1 shape - same as input
...
class DeepSpeech(nn.Module):
    def __init__(self, rnn_type, labels, rnn_hidden_size=1024, nb_layers=5, sample_rate=16000,window_size=.02,
        ...
        self.labels = labels
        self.bidirectional = bidirectional
        self.lookahead_context = context
